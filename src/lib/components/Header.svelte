...
<header class={className}>
	{#if isMobileMenuOpen}
		<div class="lg:hidden">
			<nav
				...
				class="fixed bottom-0 left-0 right-0 top-0 flex items-center justify-center bg-white text-center font-mono text-black dark:bg-black dark:text-white"
			>
				<ol class="flex flex-col gap-4 text-2xl sm:gap-6 sm:text-3xl">
					<li>
						<a
							class="duration-500 hover:text-gray-500"
							href="#about-me"
							on:click={(e) => handleClick('#about-me', e)}>About</a
						>
					</li>
					<li>
						<a
							class="duration-500 hover:text-gray-500"
							href="#experience"
							on:click={(e) => handleClick('#experience', e)}>Experience</a
						>
					</li>
					<li>
						<a
							class="duration-500 hover:text-gray-500"
							href="#projects"
							on:click={(e) => handleClick('#projects', e)}>Projects</a
						>
					</li>
				</ol>
			</nav>
	...
	<div class="py-6 font-mono text-xl text-black dark:text-white sm:py-8 lg:py-12 lg:text-2xl">
		<div class="mx-4 flex items-start justify-between sm:mx-6 lg:mx-10 lg:mx-14">
			<div
				class="xl:h-18 xl:w-18 z-20 mx-2 flex h-12 w-12 justify-center sm:h-14 sm:w-14 lg:h-16 lg:w-16"
			>
				<a
					href="#hero"
